...
class Car:
    def __init__(self):
        ...
        # Bicycle model properties
        self.steering_angle = 0.0  # Front wheel steering angle
        self.rear_x = self.x  # Rear axle position
        self.rear_y = self.y
        self.front_x = self.x  # Front axle position
        self.front_y = self.y
